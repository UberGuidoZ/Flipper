...
- [DeadZone v0.1 (By retrooper)](https://github.com/retrooper/deadzone)
...
- [Cross Remote v3.1 (By leedave)](https://github.com/leedave/flipper-zero-cross-remote)
...
- [FlipWorld v0.5 (By jblanked)](https://github.com/jblanked/FlipWorld) `Req: ESP32S2` with [FliperHTTP Firmware](https://github.com/jblanked/FlipperHTTP)
...
- [Ghost ESP v1.2.2 (By jaylikesbunda & Spooks4576)](https://github.com/Spooks4576/ghost_esp_app) `Req: ESP32` with [Ghost ESP Firmware](https://github.com/Spooks4576/Ghost_ESP)
...
- [Lab401/Light MESSENGER v1.1 (By tixlegeek)](https://github.com/lab-401/fzLightMessenger/tree/main/401lightMessengerApp)
...
- [Metroflip v0.6 (By luu176)](https://github.com/luu176/Metroflip)
...
- [Portal of Flipper v1.0 (By bettse)](https://gitlab.com/bettse/portal_of_flipper)
...
- [Quac! v0.7.2 (By rdefeo)](https://github.com/rdefeo/quac)
...
- [SPI Terminal v0.2 (By janwiesemann)](https://github.com/janwiesemann/flipper-spi-terminal)
